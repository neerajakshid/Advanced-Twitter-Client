...
public class Tweet extends Model implements Parcelable {
    ...
    public long getCurrentRetweetUser() {
        return currentRetweetUser;
    }

    public void setCurrentRetweetUser(long currentRetweetUser) {
        this.currentRetweetUser = currentRetweetUser;
    }

    private long currentRetweetUser;
    ...
    public boolean hasOriginalTweet() {
        return (retweetedTweet != null ? true : false);
    }
    ...
    public static Tweet fromJSON(JSONObject jsonObject){
        ...
        try {
            ...
            if (jsonObject.has("retweeted_status")) {
                ...
                tweet.retweetedTweet  = Tweet.fromJSON(jsonObject.getJSONObject("retweeted_status"));
   ...
   public static ArrayList<Tweet> fromJSONArray (JSONArray jsonArray){
    ...
    public static List<Tweet> getAll(long sinceId, long maxId, String query){
        if (maxId > 0){
            return new Select().from(Tweet.class)
                    .where("tweet_id > ?", sinceId).and("tweet_id <= ? ", maxId)
                    .and("body like ?", "%" + query + "%")
    ...
    public static interface OnTweetChangeListener {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.retweetedTweet, 0);
        dest.writeLong(this.currentRetweetUser);
    }
    ...
    private Tweet(Parcel in) {
        ...
        this.retweetedTweet = in.readParcelable(Tweet.class.getClassLoader());
        this.currentRetweetUser = in.readLong();
    }
