...
public class Constants {
    ...
    public static final String  REST_USER_TIMELINE_URL ="statuses/user_timeline.json";
    public static final String  REST_MENTIONS_TIMELINE_URL = "statuses/mentions_timeline.json";
    public static final String  REST_FOLLOWERS_URL= "followers/list.json";
    public static final String  REST_FOLLOWING_URL= "friends/list.json";
    public static final String  REST_SEARCH_TWEETS_URL= "search/tweets.json";
    public static final String  REST_POST_DIRECT_MESSAGE_URL = "direct_messages/new.json";
    public static final String  REST_GET_DIRECT_MESSAGE_URL = "direct_messages.json";
    public static final int REQUEST_CODE = 200;
    public static final int USERS_REQUEST_CODE = 200;
